...
Initializing a new DocumentStore within Haystack is straight forward.
...
Haystack allows for you to write store documents in an optimized fashion so that query times can be kept low.
For **sparse**, keyword based retrievers such as BM25 and TF-IDF,
you simply have to call `DocumentStore.write_documents()`.
The creation of the inverted index which optimizes querying speed is handled automatically.
        ...
        },
        {
            ...
            content: (
                ...
                <ul>
                    <li>Fully open source (Apache 2.0 license)</li>
                    <li>Essentially the same features as Elasticsearch</li>
                    <li>Has more support for vector similarity comparisons and approximate nearest neighbors algorithms</li>
                </ul>
                <strong>Cons:</strong>
                <ul>
        ...
        },
        {
            ...
            content: (
                ...
                <ul>
                    ...
                    <li>Highly scalable due to approximate nearest neighbor algorithms (ANN)</li>
        ...
        },
        {
            ...
            content: (
                ...
                <ul>
                    ...
                    <li>No Approximate Nearest Neighbors (ANN)</li>
