      ...
      content: (
        <div>
          <div style={{ marginBottom: "2rem" }}>
            <h4>RoBERTa (base)</h4>
            <p>An optimized variant of BERT and a great starting point.</p>
            <pre>
              <code>from haystack.nodes import FARMReader</code>
...
but we at deepset can more easily update and optimize the FARM pipeline for speed and performance.
