...
Haystack's knowledge graph functionalifties are still in a very early stage. Thus, don't expect our [exemplary tutorial](/tutorials/knowledge-graph) to work on your custom dataset out-of-the-box.
